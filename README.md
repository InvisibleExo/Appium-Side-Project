...
In order to run this framework, run: mvn exec:java -Dexec.mainClass="BaseTest.DriverTest" -Dexec.args=<enter an -Dplat=<Determine browser or App> -Dpackage<Provide the test package you wish to run your tests>>
